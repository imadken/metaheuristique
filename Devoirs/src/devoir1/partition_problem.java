...
public class partition_problem {
    ...
    //constructeur
	public  partition_problem(int n){
	...
	static boolean verification(int sol[]) {
	    ...
	    for (int valeur : sol) {
	        ...
	        // true si la liste contient des elements differents (1 et 2)
	...
	public static void main(String[] args)
    {
        ...
        partition_problem instance = new partition_problem(20);
